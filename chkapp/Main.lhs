\chapter{Main Program (\texttt{fsmchk})}
\begin{verbatim}
...
main
  = do putStrLn name_version
       ...
       correctOutcomes <- fullAnalysisCOSP2IdentifierUsage "test/correct.log"
       showCOSP2Outcomes "CORRECT OUTCOMES" correctOutcomes

       givenOutcomes <- fullAnalysisCOSP2IdentifierUsage "test/given.log"
       showCOSP2Outcomes "GIVEN OUTCOMES" givenOutcomes
\end{code}
